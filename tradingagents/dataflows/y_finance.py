...
# Descriptions for every stockstats indicator the agents may request. Kept at
# module scope (not inside get_stock_stats_indicators_window) so other vendors
# that compute the same indicators over their own OHLCV — e.g. the Angel One
# adapter for NSE/BSE — can reuse the exact same labels and guidance text.
